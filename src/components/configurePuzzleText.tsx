...
const EditablePuzzleInput = (props: { text: string; widgetName : string }) => {
  ...
  return (
    <div>
    <h2 className="w-full py-2.5 px-5 mb-2 text-center  text-m font-medium text-black dark:text-white">
    {props.widgetName}
    </h2>
    <React.Fragment>
      {inputVisible ? (
